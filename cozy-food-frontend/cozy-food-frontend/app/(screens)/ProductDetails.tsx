      ...
      <ScrollView className="pt-6 bg-g20 min-h-full">
        ...
        <View className="px-4 pt-4 bg-white rounded-t-xl pb-24">
          <View className="flex-row justify-between items-center">
            <View className="">
              <Text className="text-xl font-bold text-g60">
                Gildan Mens Classic
              </Text>
          ...
          <View className="flex-row justify-start items-center pt-4 border-b border-dashed border-g30 pb-4">
            <Text className="text-xl font-semibold text-g60 pr-3">$120.00</Text>
            <Text className="text-xl font-semibold text-g30 line-through">
              $140.00
            </Text>
          </View>
          <View className="pt-4">
            <View className="flex-row justify-between items-center pb-4">
              ...
              <Pressable onPress={() => router.push("/AvailableVouchers")}>
                <Text className="text-g60 text-sm font-semibold">View All</Text>
              </Pressable>
            </View>
            <View>
              <FlatList
                ...
                renderItem={({ item, index }) => (
                  <View className="p-4 rounded-xl border border-g30 bg-g20">
                    ...
                    <View className="flex-row justify-start items-center text-xs text-g50 pt-2">
                      <Text className="text-g50 pr-2">20DEALS</Text>
