  ...
  return (
    <SafeAreaView>
      <ScrollView className="pt-6 min-h-full bg-white">
        ...
        <View className="border border-g30 bg-g20 rounded-xl px-4 pb-4 mt-8 mx-4">
          {accountSecurityItems.map(({ id, name, icon }, idx) => (
            ...
            >
              <View className="flex-row justify-start items-center gap-4">
                <View className="bg-white p-3 rounded-full border-g30 flex justify-center items-center">
                  {icon}
                </View>
        ...
        <View className="px-4 pt-8 flex flex-col gap-4">
          <View className="border border-g30 p-4 rounded-xl">
            <View className="flex-row justify-between items-center">
              <Text className="text-g60 text-sm font-medium">
                Device Management
              </Text>
              <Feather name="chevron-right" size={24} color="#3f3f3f" />
            </View>
            <Text className="text-g50 pt-2 text-xs">
